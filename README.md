...
Designed, simulated, and validated an EMG signal-conditioning circuit in LTspice using a virtual ground, precision rectifier, and RC low-pass filter to extract envelope from MyoWare RAW output signal 

Built and tested the analog front end with an Arduino, breadboard, oscilloscope, and function generator; integrated with a MyoWare sensor for EMG acquisition. 
...
<p align="center" width="100%">Graph of RAW signal (yellow), as well as the rectified (pink) and smoothed (blue) signals
